const translations = {
  en: {
    ...
    heroPitch: "I build web products with Ruby on Rails, from SaaS platforms to marketing sites and side apps friends actually use.",
  ...
  pt: {
    ...
    heroPitch: "Eu construo produtos web com Ruby on Rails, de plataformas SaaS a sites de marketing e apps que amigos realmente usam.",
