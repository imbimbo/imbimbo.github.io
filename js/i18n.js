const translations = {
  en: {
    ...
    projectStyllus: "Marketing website with blog for an accounting firm, built for clear messaging, lead capture, and content publishing.",
  ...
  pt: {
    ...
    projectStyllus: "Site de marketing com blog para um escritório de contabilidade, pensado para mensagem clara, captura de leads e publicação de conteúdo.",
